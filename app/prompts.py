...
- priority: infer "urgent"/"high"/"medium"/"low" from explicit language (e.g. "rush", "ASAP", "urgent delivery") or a stated due date; default to "medium" when nothing indicates otherwise.
...
- lineItems: one entry per distinct part requested.
  - partNumber: the manufacturer part number, or the closest identifying text the customer used if no MPN is given -- but strip generic component-type words like "resistor"/"capacitor"/"transistor"/"diode" (e.g. "BC547 transistor" -> partNumber "BC547"; "10K 0805 resistor" -> partNumber "10K 0805"). Those generic words belong in description instead, not partNumber. Never invent a part number that does not appear in the source text.
